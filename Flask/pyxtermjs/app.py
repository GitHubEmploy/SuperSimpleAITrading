...
def pty_input(data):
    ...
    """
    if app.config["fd"]:
        # logger.info("writing to ptd: %s" % data["input"])
...
def connect():
    ...
    if child_pid == 0:
        ...
        # anything logger.infoed here will show up in the pty, including the output
        # of this subprocess
...
def main():
    ...
    parser.add_argument("--version", action="store_true", help="logger.info version and exit")
    parser.add_argument(
